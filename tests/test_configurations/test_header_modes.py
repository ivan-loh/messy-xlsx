...
class TestHeaderDetectionModes:
    ...
    def test_header_mode_on_simple_file(self, sample_xlsx, mode):
        ...
        config = SheetConfig(auto_detect=True, header_detection_mode=mode)
    ...
    def test_manual_mode_ignores_detection(self, messy_xlsx):
        ...
        config = SheetConfig(
            skip_rows=1, header_rows=1, header_detection_mode="manual", auto_detect=False
        )
...
class TestConfidenceThresholds:
    ...
    def test_confidence_thresholds(self, sample_xlsx, threshold):
        ...
        config = SheetConfig(
            auto_detect=True, header_detection_mode="auto", header_confidence_threshold=threshold
        )
...
class TestHeaderPatterns:
    ...
    def test_pattern_matching_boost(self, temp_dir):
        ...
        config = SheetConfig(
            auto_detect=True, header_patterns=[r".*name.*", r".*date.*", r".*amount.*"]
        )
    ...
    def test_no_pattern_match(self, temp_dir):
        ...
        config = SheetConfig(auto_detect=True, header_patterns=[r".*customer.*", r".*invoice.*"])
...
class TestHeaderFallbacks:
    ...
    def test_first_row_fallback(self, temp_dir):
        ...
        config = SheetConfig(
            auto_detect=True, header_detection_mode="auto", header_fallback="first_row"
        )
